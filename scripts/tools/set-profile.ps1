...
$Aliases = [ordered]@{
    ...
    "git-fucked"  = "C:\Users\user\Projects\phoenix\scripts\git\git-fucked.ps1"
    "delete-node" = "C:\Users\user\Projects\phoenix\scripts\tools\delete-node.ps1"
    "create-app"  = "C:\Users\user\Projects\phoenix\scripts\tools\create-app.ps1"
    "shred"       = "C:\Users\user\Projects\phoenix\scripts\tools\shred.ps1"
    "file-shift"  = "C:\Users\user\Projects\phoenix\scripts\tools\file-shift.ps1"
}

$NavFunctions = [ordered]@{
    "dl"   = "Set-Location C:\Users\user\Downloads"
    "proj" = "Set-Location C:\Users\user\Projects"
}
