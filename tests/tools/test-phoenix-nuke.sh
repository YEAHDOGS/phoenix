...
pc "has -ConfigPath parameter"     '\[string\]\$ConfigPath'
...
pc "arm-code derivation (byte-identical formula)" 'phoenix-nuke-arm\|'
pc "ARM-CODE column in table"      'ARM-CODE'
pc "arm-code transcription gate"   'Read-ArmCodeConfirmation'
pc "config-protected exclusion"    'PROTECTED\(config\)'
pc "protected beats the override"  'not even with'
pc "audit ARM-CODE"                '-Mode "ARM-CODE"'
pc "audit arm-code mismatch"       'arm-code-mismatch'
