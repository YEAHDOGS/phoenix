...
VOL="$TMP/vol"
mkdir -p "$VOL/Users/user/Documents" "$VOL/Users/user/Desktop" \
         "$VOL/Users/user/Downloads" "$VOL/Users/user/.ssh" \
         "$VOL/Users/Public/Documents" "$VOL/Users/user/Ableton Projects"
echo "resume text"    > "$VOL/Users/user/Documents/resume.txt"
echo "wallet export"  > "$VOL/Users/user/Desktop/wallet.txt"
echo "installer"      > "$VOL/Users/user/Downloads/setup.exe"
echo "screenshot"     > "$VOL/Users/user/Desktop/pic.png"
echo "private key"    > "$VOL/Users/user/.ssh/id_ed25519"
echo "loop stems"     > "$VOL/Users/user/Ableton Projects/stems.wav"
...
[[ ! -e "$OUT1/Users/user/Downloads/setup.exe" ]] \
...
[[ -f "$OUT3/Users/user/Downloads/setup.exe" ]] \
...
OUT4="$TMP/bak4"
run "profiles+extra exits 0" 0 -- B "$OUT4" --profiles user --extra "Users/user/Ableton Projects"
[[ -f "$OUT4/Users/user/Ableton Projects/stems.wav" ]] \
...
[[ ! -e "$OUT4B/Users/user/Documents/resume.txt" ]] \
    && pass "user excluded when only Public selected" || fail "Public-only profile selection"
